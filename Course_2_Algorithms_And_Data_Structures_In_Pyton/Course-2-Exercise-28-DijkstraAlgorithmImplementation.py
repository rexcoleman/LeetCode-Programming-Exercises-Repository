...
class Node:
    ...
    # after inserting these objects into the heap data structure
    ...
    def calculate(self, start_vertex):
        ...
        while self.heap:
            ...
            for edge in actual_vertex.adjacency_list:
                ...
                # compare the min distances
                new_distance = u.min_distance + edge.weight

                # there is a shorter path the the v vortex
                if new_distance < v.min_distance:
                    ...
                    # plus O(logN) to handle the heap again [O(N) + O(logN) = O(N)]
                    # Fibonacci heaps - O(1)
