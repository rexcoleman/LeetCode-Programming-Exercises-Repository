...
class Solution:
    def closestValue(self, root: Optional[TreeNode], target: float) -> int:
        def inorder(r: TreeNode):
            ...
            # Perform inorder traversal on the left subtree
            left = inorder(r.left)

            # Include the current node's value
            current = [r.val]

            # Perform inorder traversal on the right subtree
        ...
        # The inorder function returns a sorted list: e.g. [1,2,3,4,5]
        # Using the key function inside a min function allows you to compare the values in the list to the target value
