...
airline_data = pd.read_csv('/Users/rexcoleman/Downloads/airline_data.csv', encoding="ISO-8859-1", dtype={'Div1Airport': str, 'Div1TailNum': str, 'Div2Airport': str, 'Div2TailNum': str})
